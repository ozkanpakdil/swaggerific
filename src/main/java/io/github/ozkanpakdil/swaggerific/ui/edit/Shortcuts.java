...
public class Shortcuts implements Initializable {
    ...
    private enum CaptureTarget { NONE, SEND, DEBUG }
    ...
    private void handleCaptureEvent(KeyEvent e) {
        ...
        if (capturing == CaptureTarget.SEND) {
            txtSendRequest.setText(formatted);
        } else if (capturing == CaptureTarget.DEBUG) {
            txtToggleDebug.setText(formatted);
        }
