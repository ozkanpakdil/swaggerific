            ...
            try {
                ...
                test.put("assertEquals", (java.util.function.Function<Object[], Boolean>) args -> {
                    if (args.length < 3) {
                        ...
                        testAssertionResults.add(new AssertionResult(false, message + ": Not enough arguments for assertEquals"));
                        return false;
                    }
                ...
                test.put("assertFalse", (java.util.function.Function<Object[], Boolean>) args -> {
                    if (args.length < 2) {
                        String message = args.length > 0 ? args[0].toString() : "Assertion failed";
                        testAssertionResults.add(new AssertionResult(false, message + ": Not enough arguments for assertFalse"));
                        return false;
                    }
                ...
                test.put("assertContains", (java.util.function.Function<Object[], Boolean>) args -> {
                    if (args.length < 3) {
                        String message = args.length > 0 ? args[0].toString() : "Assertion failed";
                        testAssertionResults.add(new AssertionResult(false, message + ": Not enough arguments for assertContains"));
                        return false;
                    }
